...
export function Features() {
  const features = [
    ...
    },
    {
      ...
      desc: "Access a rich library of frameworks, checklists, and templates to optimize your trades.",
      color: "bg-brand-sky"
    },
    {
      title: "Verified tutors",
      desc: "Learn only from individuals with publicly verified and transparent profit track records.",
    ...
    <SectionWrapper className="bg-brand-dark/[0.015]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-24 max-w-5xl mx-auto">
        {features.map((feature, idx) => (
          <Card key={idx} className="p-10 flex flex-col items-start bg-white hover:bg-brand-dark/[0.01] transition-colors border-none ring-1 ring-brand-dark/[0.04]">
