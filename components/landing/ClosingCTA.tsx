      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
          <div className="bg-brand-blue text-white rounded-[2rem] p-10 flex flex-col justify-end min-h-[240px] shadow-xl shadow-brand-blue/20 transform hover:-translate-y-2 transition-transform">
            ...
            <div className="text-5xl font-extrabold mb-2 tracking-tight">100%</div>
          ...
          <div className="bg-brand-green text-white rounded-[2rem] p-10 flex flex-col justify-end min-h-[240px] shadow-xl shadow-brand-green/20 transform sm:translate-y-8 hover:-translate-y-2 transition-transform">
            ...
            <div className="text-5xl font-extrabold mb-2 tracking-tight">5k+</div>
            <div className="text-lg font-medium text-white/80">Scaled Traders Target</div>
          </div>
        </div>

        {/* Right Side: CTA Text */}
        <div className="flex-1 flex flex-col items-start text-left lg:pl-10">
          <Typography variant="H2" className="text-4xl md:text-5xl lg:text-6xl mb-8 leading-[1.1] tracking-tight">
            Ready to give yourself a <span className="text-brand-blue">6-figure</span> growth chance?
          </Typography>

          <Typography variant="Body" className="text-xl text-brand-dark/60 mb-10 leading-relaxed font-medium max-w-lg">
            Join the ecosystem built by real traders, for real traders. Elevate your portfolio with battle-tested strategies.
          </Typography>

          <Link href="/chronicle">
            <Button variant="primary" size="lg" className="h-14 px-10 text-lg shadow-lg shadow-brand-blue/25">
